...
const Drawer: React.FC<DrawerProps> = ({
  ...
  const withAnimation = (destination: number) =>
    withTiming(destination, { duration: durationMs, easing }, (finished) => {
      'worklet';
      ...
      runOnJS(onAnimationEnd)(destination > 0.5 ? 'open' : 'closed');
    });

  useEffect(() => {
    animationProgress.value = withAnimation(isOpen ? 1 : 0);
